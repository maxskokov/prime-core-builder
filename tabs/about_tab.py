...
def show_about_tab():
    # ── ПРЕМИУМ ЛЕНДИНГ "ULTIMATE CORE" 6.0 ──
    # ПОЛНОСТЬЮ БЕЗ ОТСТУПОВ И ПУСТЫХ СТРОК ДЛЯ ИСПРАВЛЕНИЯ БАГА ОТОБРАЖЕНИЯ.
    # ДАТА: 2026 ГОД.
    st.markdown("""
<style>
...
<div class="scroll-indicator">ПРЕЗЕНТАЦИЯ 2026 ▼</div>
</div>
...
<p class="bento-p">Все анализируемые тексты проходят через фильтр анонимности. Мы не храним ваши личные данные — только чистую аналитику смыслов по стандартам 2026 года.</p>
</div>
<div class="bento-card">
...
<p class="bento-p">Анализ текста объемом в тысячи слов занимает менее 1 секунды. Технологии Streamlit Cloud обеспечивают максимальную плавность работы в 2026 году.</p>
</div>
</div>
</div>
<div class="presentation-section">
<h2 class="hero-title">Готовы к <br><span class="accent">Будущему?</span></h2>
<div style="margin-top: 40px; font-size: 1.5rem; color: #4b5563;">Prime Core: Builder v3.0 • Март 2026</div>
</div>
